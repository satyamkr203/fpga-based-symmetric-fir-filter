...
REM
REM Generated by Vivado on Sat May 30 19:25:20 +0530 2026
...
echo "xvlog --incr --relax -prj symmetricFIR_tb_vlog.prj"
call xvlog  --incr --relax -prj symmetricFIR_tb_vlog.prj -log xvlog.log
