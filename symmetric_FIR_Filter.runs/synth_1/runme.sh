...
HD_PWD='C:/Users/shova/Desktop/symmetric_FIR_Filter/symmetric_FIR_Filter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log symmetricFIR.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source symmetricFIR.tcl
