...
HD_PWD='C:/Users/shova/Desktop/symmetric_FIR_Filter/symmetric_FIR_Filter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log symmetricFIR.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source symmetricFIR.tcl -notrace
